        ...
        <div className="text-center space-y-2">
{
  ...
  <div className="flex space-x-2">
    <div className="w-3 h-3 bg-primary rounded-full bg-button-base animate-bounce [animation-delay:-0.3s]"></div>
    <div className="w-3 h-3 bg-primary rounded-full bg-button-base animate-bounce [animation-delay:-0.15s]"></div>
    <div className="w-3 h-3 bg-primary rounded-full bg-button-base animate-bounce"></div>
  </div>
</div>
}
{
  ...
  <Link
          className="block text-center w-full    px-2 py-4 text-2xl mt-5   bg-button-base rounded-lg  text-button-base"
          href="/period"
          onClick={()=>{
            setisReroute(true)
